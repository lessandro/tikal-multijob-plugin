...
public class ConditionalPhaseTest {
	...
	public void testConditionalPhase() throws Exception {
		...
		PhaseJobsConfig firstPhase = new PhaseJobsConfig("free", null, true, null, KillPhaseOnJobResultCondition.NEVER,
		...
		MultiJobBuilder firstPhaseBuilder = new MultiJobBuilder("FirstPhase", configTopList,
		...
		Assert.assertEquals("there should be two phases and three projects", 5,
				multi.getView().getRootItem(multi).size());

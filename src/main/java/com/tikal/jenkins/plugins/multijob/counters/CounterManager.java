 ...
 * <p>
 * A manager process the results of the jobs, the result of the phase and
 * transforms the counters and their values in the data structure needed by the
 * Multijob.injectEnvVars.
 * </p>
 * <p>
 ...
 *
 * <p>
 * <b>The variables related to the last phase execution:</b>
 * </p>
 * <ul>
 * <li><b>PHASE_RESULT</b>: with the result (as string) of the previous phase.
 * </li>
 * <li><b>PHASE_SUCCESSFUL</b>: the number of jobs with UNSTABLE or SUCCESS
 * results.</li>
 ...
 *
 * <p>
 * <b>The variables related to the phase name (in the following example, TRALL
 * is the phase name):</b>
 * </p>
 * <ul>
 * <li><b>TRALL_RESULT</b>: with the result (as string) of the previous phase.
 * </li>
 * <li><b>TRALL_SUCCESSFUL</b>: the number of jobs with UNSTABLE or SUCCESS
 * results.</li>
 ...
 *
 * <p>
 * <b>The variables related to current multijob execution:</b>
 * </p>
 * <ul>
 * <li><b>MULTIJOB_RESULT</b>: with the result (as string) of the previous
 * phase.</li>
 * <li><b>MULTIJOB_SUCCESSFUL</b>: the number of jobs with UNSTABLE or SUCCESS
 * results.</li>
...
public final class CounterManager {
	/**
	 * Name of the key that will be used to store, as an environment property,
	 * the result of the phase.
	 * <p>
	 * We compute the result of the phase as the worse of the results of all
	 * triggered jobs.
	 * </p>
	 */
	...
	/**
	 * The phase result. It is computed as the worse of the results of all
	 * triggered jobs.
	 */
	private Result phaseResult = Result.SUCCESS;

	public CounterManager() {
		final Map<CounterKey, AtomicInteger> counters = new HashMap<CounterKey, AtomicInteger>(
				CounterKey.values().length);
	 ...
	 * <p>
	 * The processing of the result of the job is an operation that involucres
	 * two steps:
	 * </p>
	 * <ol>
	 * <li>First, we increment all of the counters this result applies to.</li>
	 * <li>Second, we update the <code>phaseResult</code> variable if the result
	 * if worse than current.</li>
	 * </ol>
	 *
	 * @param result

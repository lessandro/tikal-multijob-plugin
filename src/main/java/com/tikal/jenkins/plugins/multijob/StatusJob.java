 ...
 * <p>
 * These are used to compute the {@link MultiJobBuilder#JOB_IS_BUILDABLE}
 * variable. There is only one status available for each job, and the current
 * check sequence is described at MultiJobBuilder.getScmChange().
 * </p>
 * 
 */
public enum StatusJob {
	 ...
	 *
	 * @return <code>true</code> the job will be built, <code>false</code> the
	 *         job will not be built.
	 */
	 ...
	 * 
	 * @param subjob
	 *            the job associated to this status job.
